...
function Stat({ label, value, sub, warn, link }: StatProps) {
  return (
...
type AdminCardTone = "primary" | "warn" | "hivis" | "ink";
  ...
  return (
    <div className="pl-card">
      <div className="pl-card-head" style={{ alignItems: "flex-start" }}>
        ...
        {filter && <Icon name="filter" size={13} style={{ color: "var(--ink-5)" }} />}
        <span className="pl-link" style={{ fontSize: 11.5 }}>
          View all
        </span>
      </div>
      <div>{children}</div>
...
export function AdminHomeScreen({ userName = "there" }: { userName?: string }) {
  return (
    <>
      <div className="pl-page-head">
        <div className="pl-page-title-row">
          <div>
            ...
            >
              Saturday · May 16 · Vertex Safety Solutions
            </div>
            <div className="pl-page-title">Good morning, {userName}</div>
          </div>
          <div className="pl-page-actions">
            <Btn ico="upload" variant="ghost">
              Bulk import
            </Btn>
            <Btn ico="plus">Quick add</Btn>
            <Btn variant="primary" ico="folder">
              New project
            </Btn>
          </div>
        </div>
      ...
      <div className="pl-scroll" style={{ padding: "18px 24px 24px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14 }}>
          <AdminCard
            ...
            tone="primary"
            ico="check"
            sub="Submitted by Project Managers · sorted by submission time"
          >
            {[
              {
                code: "PRJ-2026-043",
              ...
              {
                code: "PRJ-2026-042",
                name: "Pier 39 Maintenance Access",
                client: "Port of SF",
                pm: "R. Mathers",
                lines: 24,
                total: 14380,
          ...
          <AdminCard
            title="Nearing due · incomplete MTO"
            count={3}
            tone="warn"
            ico="warn"
            sub="Issue rate vs days remaining"
          >
            {[
              {
                code: "PRJ-2026-038",
              ...
              <ListRow key={p.code}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 11, color: "var(--ink-4)" }}>
                    ...
                    <span
                      style={{
                        color: p.daysLeft === 0 ? "var(--hivis-ink)" : "var(--ink-2)",
                        fontWeight: 500,
                      }}
                      className="mono"
                    >
                ...
                <div style={{ width: 80 }}>
                  <ProgressBar
                    value={p.pct}
                    max={100}
                    tone={p.daysLeft === 0 && p.pct < 100 ? "warn" : ""}
                  />
                  <div
                    className="mono tnum"
                    style={{
          ...
          <AdminCard
            ...
            tone="hivis"
            ico="warn"
            sub="Need re-review · soft-locked after PM edits"
          >
            {[
              {
                code: "PRJ-2026-038",
                name: "Aurora Bridge — North Span",
                changes: "+12.6 m cable · +20 bolts",
                who: "A. Chen",
                when: "2h ago",
              },
              {
                code: "PRJ-2026-040",
                name: "Cypress Wind Farm — T-14",
                changes: "Substitute LL-CBL-10 → 8",
                who: "D. Khoury",
                when: "Yesterday",
              },
            ].map((p) => (
          ...
          <AdminCard
            ...
            tone="warn"
            ico="package"
            sub="Below reorder level · 4 critical"
          >
            {[
              {
                th: "🔩",
                sku: "BLT-BMET-14",
                name: "Bi-metal Self-Drill, 14 mm",
                stock: 0,
                reorder: 200,
                locs: 0,
                crit: true,
              },
              {
                th: "🧷",
                sku: "TRM-END-10-K",
                name: "End Termination Kit, 10 mm",
                stock: 4,
                reorder: 12,
                locs: 1,
                crit: true,
              },
              {
                th: "🔧",
                sku: "INT-ANC-12",
                name: "Intermediate Anchor, 12 mm",
                stock: 14,
                reorder: 30,
                locs: 2,
              },
                ...
                <div style={{ textAlign: "right", width: 90 }}>
                  <div
                    ...
                    style={{
                      fontSize: 13,
                      fontWeight: 600,
                      color: m.crit ? "var(--danger)" : "var(--hivis-ink)",
                    }}
                  >
                    {m.stock}
                  </div>
          ...
          <AdminCard
            ...
            tone="hivis"
            ico="cert"
            sub="Within 30 days · models flagged on save"
          >
            {[
              {
                cert: "OSHA 1926.502 attest",
                model: "Cable Lifeline 8mm SS316",
                exp: "26 days",
                tone: "warn",
              },
              {
                cert: "EN 795:2012 Type B",
                model: "Type-A Swivel Anchor SS",
                exp: "12 days",
                tone: "crit",
              },
              {
                cert: "AS/NZS 1891.4 issuance",
                model: "Modular Guardrail 1.1m",
                exp: "4 days",
                tone: "crit",
              },
            ].map((c, i) => (
              <ListRow key={i}>
                <Icon
                  ...
                  size={14}
                  style={{
                    color: c.tone === "crit" ? "var(--danger)" : "var(--hivis-ink)",
                  }}
                />
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div
                ...
                <Icon name="upload" size={13} style={{ color: "var(--ink-5)" }} />
              </ListRow>
            ))}
          </AdminCard>
          ...
          <AdminCard
            ...
            tone="ink"
            ico="history"
            sub="Filter by location · type · material"
            filter
          >
            {[
              {
                ico: "arrowDown",
                tone: "success",
                label: "Receipt · 200 m CBL-SS-08-100",
                meta: "SF Yard A · R. Mathers · 09:14",
              },
              {
                ico: "arrowUp",
                tone: "primary",
                label: "Issuance · 250 m → Aurora Bridge",
                meta: "SF Yard A · R. Mathers · 09:18",
              },
              {
                ico: "fork",
                tone: "ink",
                label: "Transfer · 12 INT-ANC-12 → Oakland",
                meta: "A. Chen · 10:02",
              },
              {
                ico: "refresh",
                tone: "warn",
                label: "Return · 8 m GR-RAIL → Pier 39",
                meta: "D. Khoury · 11:24",
              },
              {
                ico: "settings",
                tone: "ink",
                label: "Adjustment · −4 m CBL-SS-08-100",
                meta: "Annual count · admin · 14:05",
              },
            ].map((m, i) => (
